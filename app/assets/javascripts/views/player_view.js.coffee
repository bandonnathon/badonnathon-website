define [
  ...
  class PlayerView extends View
    ...
    showLatest: (collection) ->
      ...
      $('.latestSong').append('<iframe src="https://embed.spotify.com/?uri=spotify:user:paul.carvill:playlist:5cO2C8jfCykbXzb84Eheea" width="100%" height="80" frameborder="0" allowtransparency="true"></iframe>')
